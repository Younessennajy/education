    ...
    <div className='flex items-center justify-center md:flex-col'>
      <div className='left w-1/2 text-black md:w-full'>
        <h1 className='text-4xl leading-tight text-black font-semibold'>
          Lancez votre <br /> propre plateforme <br /> d'apprentissage en ligne
        </h1>
        <h3 className='text-lg mt-3'>Accès illimité à plus de 60 instructeurs.</h3>
        <span className='text-[14px]'>2 abonnements (avec accès à toutes les classes) pour 240 $</span>

        <div className='relative text-gray-600 focus-within:text-gray-400 mt-5'>
          <input type='search' className='py-3 text-sm bg-white rounded-md pl-10 focus:outline-none' placeholder='Rechercher...' autoComplete='off' />
        ...
        <span className='text-[14px]'>Vous êtes sûr de trouver quelque chose qui vous convient.</span>
      </div>
        ...
        <div className='content'>
          <button className='bg-white shadow-md absolute top-56 left-0 z-30 p-2 flex items-center rounded-md'>
            ...
            <div className='text flex flex-col items-start px-4'>
              <span className='text-sm text-black'>Félicitations</span>
              <span className='text-[12px]'>Votre admission est terminée</span>
            </div>
          </button>
          <button className='bg-white shadow-md absolute bottom-32 left-48 z-30 p-2 flex items-center rounded-md pr-8'>
            ...
            <div className='text flex flex-col items-start px-4'>
              ...
              <span className='text-[12px]'>Étudiants assistés</span>
            </div>
          </button>
          <button className='bg-white shadow-md absolute top-56 -right-32 z-30 p-2 md:top-96 md:-right-5 flex items-center rounded-md'>
            ...
            <div className='text flex flex-col items-start px-4'>
              <span className='text-sm text-black'>Cours d'expérience utilisateur</span>
              <span className='text-[12px]'>Demain est notre</span>
            </div>
          </button>
